...
var AppGeom  = (function () {
	...
	var AppGeom = {
		...
		//to detect which side, can be - or +
		distToLineRelative: function (point, lineA, lineB){
		...
		// checks if a point is within an oval (without oval rotation)
		...
		Bezier: {
			...
			getAngle: function(t,C0,C1,C2,C3){
				...
				return -AppGeom.getAngle(posA, posB);
			},
			//multiplier - position along from 0 to 1
